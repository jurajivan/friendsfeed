...
function insertFriendsFeedNews() {
	...
	document.querySelector('#hideFriendsFeedNews').addEventListener("click", function(event) {
		...
		chrome.storage.sync.set({
			hideFriendsFeedNewsVersion: friendsFeedNews.version
		});
	}, false);
	document.querySelector('.ff_share_button').addEventListener("click", function(event) {
		event.preventDefault();
		windowPopup("https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Ffoxvalleyapps.com%2Ffriendsfeed%2F", 560, 360);
	}, false);
}
